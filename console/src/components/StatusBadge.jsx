...
const statusConfig = {
  ...
  suspended: { dotClass: 'status-dot bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.5)]', badgeClass: 'badge-amber', label: 'Suspended' },
  not_deployed: { dotClass: 'status-dot bg-slate-400', badgeClass: 'badge-gray', label: 'Not Deployed' },
  unattached: { dotClass: 'status-dot bg-slate-400', badgeClass: 'badge-gray', label: 'Unattached' },
